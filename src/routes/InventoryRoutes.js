...
router.delete("/item-category/:id", UpdateItemCategory);
...
router.delete("/item-store/:id", UpdateItemStore);
...
router.delete("/item-supplier/:id", UpdateItemSupplier);
