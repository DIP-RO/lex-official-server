...
import {
  ...
  deleteClass,
  getAllClass,
} from "../controllers/academic/classControllers.js";
import {
  UpdateClassTeacher,
  createClassTeacher,
  deleteClassTeacher,
  getAllClassTeacher,
} from "../controllers/academic/classTeacherControllers.js";
import {
  UpdateClassTimeTable,
  createClassTimeTable,
  deleteClassTimeTable,
  getAllClassTimeTable,
} from "../controllers/academic/classTimeTableControllers.js";
import {
  UpdatePromoteStudent,
  createPromoteStudent,
  deletePromoteStudent,
  getAllPromoteStudent,
} from "../controllers/academic/promeStudentsControllers.js";
import {
  UpdateSection,
  createSection,
  deleteSection,
  getAllSection,
} from "../controllers/academic/sectionsControllers.js";
import {
  UpdateSubjectGroup,
  createSubjectGroup,
  deleteSubjectGroup,
  getAllSubjectGroup,
} from "../controllers/academic/subjectGroupControllers.js";
import {
  UpdateSubject,
  createSubject,
  deleteSubject,
...
router.get("/class-teacher/:id", getAllClassTeacher);
...
router.get("/class-time-table/:id", getAllClassTimeTable);
...
router.get("/class-promote-student/:id", getAllPromoteStudent);
...
router.get("/section/:id", getAllSection);
/* End */
/* subject-group */
...
router.get("/subject-group/:id", getAllSubjectGroup);
/* End */
/* subject */
...
router.get("/subject/:id", getAllSubject);
/* End */
